    ...
    >
      <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
        <ScrollView style={styles.container}>
          {!photo ? (<Camera style={styles.camera} type={type} ref={setCameraRef}>
            <View style={styles.cameraWrapper}>
              <TouchableOpacity style={styles.flipCameraButtonStyle} onPress={toggleCameraType}>
          ...
          >
            <Text style={styles.hintMessage}>{!photo ? 'Завантажте фото' : 'Редагувати фото'}</Text>
          </TouchableOpacity>
          <TextInput
          ...
          <View style={styles.iconAndInputWrapper}>
            <View style={[styles.postDataInputStyle, styles.locationTitleInputStyle]}>
              <MapPin />
            </View>
            <TextInput
              style={[styles.postDataInputStyle, styles.locationTitleInputStyle, styles.locationTitleInputWidth]}
          ...
          <TouchableOpacity
            style={[styles.buttonStyle, photo && title && locationTitle && styles.readyToPuplish]}
            activeOpacity={0.5}
            onPress={handleSubmitButton}>
            <Text style={[styles.buttonTextStyle, photo && title && locationTitle && styles.readyToPuplish]}>Опублікувати</Text>
          </TouchableOpacity>
          <TouchableOpacity
