                ...
                <KeyboardAvoidingView behavior={Platform.OS == "ios" ? "padding" : "height"}>
                    <View style={styles.Wrapper}>
                        ...
                        <TouchableOpacity
                            ...
                            activeOpacity={0.5}
                            onPress={handleSubmitButton}>
                          <Text style={styles.secondaryButtonTextStyle}>Немає акаунту? <Text style={styles.underlinedText} onPress={() => navigation.navigate("RegistrationScreen")}>Зареєструватися</Text></Text>
                        </TouchableOpacity>
                    </View>
                </KeyboardAvoidingView>
            </TouchableWithoutFeedback>
