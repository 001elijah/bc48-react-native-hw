                ...
                <KeyboardAvoidingView behavior={Platform.OS == "ios" ? "padding" : "height"}>
                    <View style={styles.Wrapper}>
                        ...
                        <View style={styles.SectionStyle}>
                            <TextInput
                                style={isUserNameInFocus ? styles.inputInFocusStyle : styles.inputStyle}
                        ...
                        <View style={styles.SectionStyle}>
                            <TextInput
                                style={isUserEmailInFocus ? styles.inputInFocusStyle : styles.inputStyle}
                        ...
                        <View style={[styles.SectionStyle, styles.SectionStyleLast]}>
                            <TextInput
                                style={isUserPasswordInFocus ? styles.inputInFocusStyle : styles.inputStyle}
                        ...
                        <TouchableOpacity
                            ...
                            activeOpacity={0.5}
                            onPress={handleSubmitButton}>
                            <Text style={styles.secondaryButtonTextStyle}>Вже є акаунт? <Text style={styles.underlinedText} onPress={() => navigation.navigate("LoginScreen")}>Увійти</Text></Text>
                        </TouchableOpacity>
                    </View>
                </KeyboardAvoidingView>
            </TouchableWithoutFeedback>
